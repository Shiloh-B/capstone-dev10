...
begin
    ...
    insert into message(message, `timestamp`, room_id, user_id, username) values("test", 10000, 1, 1, "nik");
    insert into message(message, `timestamp`, room_id, user_id, username) values("test2", 10001, 1, 1, "nik");
    insert into message(message, `timestamp`, room_id, user_id, username) values("test3", 10002, 1, 1, "nik");
